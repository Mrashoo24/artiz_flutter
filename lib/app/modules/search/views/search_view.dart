...
import '../../e_provider/views/searchProviders.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(
        children: [
          buildSearchBar(),
          // SearchServicesListWidget(services: controller.eProviders),
          // SearchProductListWidget(services: controller.eProviders),
          SearchProviders(true,Get.find<HomeController>().eProviderList,controller.textEditingController.text)
        ],
      ),
    );
  }
