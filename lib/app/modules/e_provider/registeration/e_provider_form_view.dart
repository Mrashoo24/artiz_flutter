...
import 'package:home_services/app/modules/e_provider/registeration/widgets/horizontal_stepper_widget.dart';
import 'package:home_services/app/modules/e_provider/registeration/widgets/step_widget.dart';
                  ...
                  final confirm = await showDialog<bool>(
                    ...
                    builder: (BuildContext context) {
                      return ConfirmDialog(
                        ...
                        content: "Are you sure you want to delete this provider?".tr,
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                        ...
                        children: [
                          Row(
                            children: [
                              ...
                              MaterialButton(
                                onPressed: () async {
                                  final selectedValue = await showDialog<Category>(
                                    context: context,
                                    builder: (BuildContext context) {
                                      return SelectDialog(
                                        ...
                                        cancelText: "Cancel".tr,
                                        items: controller.getSelectProviderTypesItems(),
                                        initialSelectedValue: controller.eProviderTypes.firstWhere(
                                          (element) => element.id == controller.eProvider.value.category?.id,
                                          orElse: () => new Category(),
                                        ),
                                      );
                                    },
                                  ...
                                  controller.eProvider.update((val) {
                                    val.category = selectedValue;
                                  });
                                  await controller.getTaxes();
                                },
                                shape: StadiumBorder(),
                          ...
                          Obx(() {
                            if (controller.eProvider.value?.category == null) {
                              return Padding(
                ...
                //                           .where(
                //                             (user) => controller.eProvider.value.employees?.where((element) => element.id == user.id)?.isNotEmpty ?? false,
                //                           )
                //                           .toSet(),
                //                     );
                //                   },
                ...
                //         ),
                //         Obx(() {
                //           if (controller.eProvider.value?.employees?.isEmpty ?? true) {
                //             return Padding(
                //               padding: EdgeInsets.symmetric(vertical: 20),
                //               child: Text(
                //                 "Select Employees".tr,
                ...
                Obx(()=>Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        controller.eProvider.value.category == null ? SizedBox() :MaterialButton(
                              onPressed: () async {
                                  ...
                                  builder: (BuildContext context) {
                                    return MultiSelectDialog(
                                      ...
                                      initialSelectedValues: controller.taxes
                                          .where(
                                            (tax) => controller.eProvider.value.subCategory?.where((element) => element.id == tax.id)?.isNotEmpty ?? false,
                                          )
                                          .toSet(),
                                    );
                                  },
                                ...
                                controller.eProvider.update((val) {
                                  val.subCategory = selectedValues?.toList();
                                });
                              },
                              shape: StadiumBorder(),
                              color: Get.theme.colorScheme.secondary.withOpacity(0.1),
                        ...
                        Obx(() {
                          if (controller.eProvider.value?.subCategory?.isEmpty ?? true) {
                            return Padding(
                              padding: EdgeInsets.symmetric(vertical: 20),
                              child: Text(
  ...
  Widget buildTaxes(EProvider _eProvider) {
    return Padding(
      ...
      child: Wrap(
          ...
          spacing: 5,
          runSpacing: 8,
          children: List.generate(_eProvider.subCategory?.length ?? 0, (index) {
            final tax = _eProvider.subCategory.elementAt(index);
            return Container(
              padding: EdgeInsets.symmetric(horizontal: 10, vertical: 4),
  ...
  Widget buildProviderType(EProvider _eProvider) {
    return Padding(
      ...
      child: Container(
        ...
        child: Text(_eProvider.category?.name ?? '', style: Get.textTheme.bodyText2),
