...
class EServiceView extends GetView<EServiceController> {
 ...
 print( '+91' +  _eService.ph_no == ( Get.find<AuthService>().user.value.phoneNumber));
            ...
            children: [
              Expanded(
                child: Row(
                  ...
                  if(_eService.ph_no == ( Get.find<AuthService>().user.value.phoneNumber))  IconButton(onPressed: (){
                   Get.find<EServiceFormController>().eService.value = _eService;
