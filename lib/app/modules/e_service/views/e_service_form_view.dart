...
import '../../e_provider/registeration/widgets/horizontal_stepper_widget.dart';
import '../../e_provider/registeration/widgets/step_widget.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          title: Obx(() {
            return Text(
              controller.isCreateForm() ? "Create Product".tr : controller.eService.value.name ?? '',
          ...
          leading: new IconButton(
            ...
            onPressed: () async {
              ...
              //     ? await Get.offAndToNamed(Routes.E_SERVICE)
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                // TextFieldWidget(
                //   onSaved: (input) => controller.eService.value.ph_no = input,
                //   onChanged: (input) => controller.eService.value.ph_no = input,
                //
                //   validator: (input) => input.length < 9 ? "Should be more than 9 letters".tr : null,
                //   initialValue: controller.eService.value.ph_no ?? '',
                ...
                Obx(() {
                  ...
                  if( controller.eService.value.eProvider == null )     controller.eService.value.eProvider = controller.eProviders.first;
                    return SizedBox();
