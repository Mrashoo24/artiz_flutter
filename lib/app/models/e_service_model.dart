...
class EService extends Model {
  ...
  EService(
      ...
      this.categories,
      this.subCategories,
      this.eProvider,this.ph_no,this.sold});
  ...
  EService.fromJson(Map<String, dynamic> json) {
    ...
    ph_no = stringFromJson(json, 'ph_no');
    sold = stringFromJson(json, 'sold');
    super.fromJson(json);
  }
