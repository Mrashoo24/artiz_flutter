...
import '../modules/e_provider/bindings/e_provider_bindings.dart';
import '../modules/e_provider/registeration/address_picker_view_for_vendor.dart';
import '../modules/e_provider/registeration/e_provider_addresses_form_view.dart';
import '../modules/e_provider/registeration/e_provider_form_view.dart';
import '../modules/e_provider/views/e_provider_e_services_view.dart';
import '../modules/e_provider/views/e_provider_list.dart';
import '../modules/e_provider/views/e_provider_view.dart';
import '../modules/e_service/bindings/e_service_binding.dart';
import '../modules/e_service/views/e_service_form_view.dart';
import '../modules/e_service/views/e_service_view.dart';
import '../modules/e_service/views/options_form_view.dart';
...
class Theme1AppPages {
  ...
  static final routes = [
    ...
    GetPage(name: Routes.E_PROVIDERList, page: () => EproviderCarouselWidget(false), binding: EProviderBinding()),
    GetPage(name: Routes.OPTIONS_FORM, page: () => OptionsFormView(), binding: EServiceBinding(), middlewares: [AuthMiddleware()]),
    GetPage(name: Routes.E_SERVICE_FORM, page: () => EServiceFormView(), binding: EServiceBinding(), middlewares: [AuthMiddleware()]),
    ...
    GetPage(name: Routes.E_PROVIDER_ADDRESS_PICKER, page: () => AddressPickerViewVendor(), binding: EProviderBinding(), middlewares: [AuthMiddleware()]),
    // GetPage(name: Routes.E_PROVIDER, page: () => EProviderView(), binding: EProviderBinding(), middlewares: [AuthMiddleware()]),
    GetPage(name: Routes.E_PROVIDER_E_SERVICES, page: () => EProviderEServicesView(), binding: EProviderBinding(), middlewares: [AuthMiddleware()]),
