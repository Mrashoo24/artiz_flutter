...
class LaravelApiClient extends GetxService with ApiClient {
  ...
  Future<List<Address>> getAddresses() async {
    ...
    var response = await _httpClient.getUri(_uri, options: _optionsCache);
    Get.log('addressResponse' + response.toString());
    if (response.data['success'] == true) {
  ...
  Future<List<EProvider>> getAllEproviders() async {
    // const _queryParameters = {
    //   'with': 'eProviderType;availabilityHours;users;addresses',
    // };
    Uri _uri = getApiBaseUri("e_providers");
    Get.log(_uri.toString());
    var response = await _httpClient.getUri(_uri, options: _optionsNetwork);
    if (response.data['success'] == true) {


      Get.log('providerList = ${response.data['data']}');

     List<EProvider> eproviderList = response.data['data'].map<EProvider>((e) => EProvider.fromJson(e)).toList();
  ...
  Future<List<EProviderType>> getEProviderTypes() async {
    ...
    Uri _uri = getApiBaseUri("provider/e_provider_types").replace(queryParameters: _queryParameters);
  ...
  Future<User> createEProvider(EProvider _eProvider) async {
    ...
    Uri _uri = getApiBaseUri("e_providers").replace(queryParameters: _queryParameters);

    var response = await _httpClient.postUri(_uri, data: _eProvider.toJsonUpload(), options: _optionsNetwork);
    if (response.data['success'] == true) {
      print('responsevendor  = ${response.data['data']}');
      return User.fromJson(response.data['data']);
    } else {
      throw new Exception(response.data['message']);
    }
  ...
  Future<User> updateEProvider(EProvider _eProvider) async {
    var _queryParameters = {
      'api_token': authService.apiToken,
    };
  ...
  Future<User> deleteEProvider(EProvider _eProvider) async {
    var _queryParameters = {
      'api_token': authService.apiToken,
    };
    Uri _uri = getApiBaseUri("e_providers/${_eProvider.id}").replace(queryParameters: _queryParameters);
  ...
  Future<List<User>> getAllEmployees() async {
    ...
    Uri _uri = getApiBaseUri("provider/employees").replace(queryParameters: _queryParameters);
  ...
  Future<List<Tax>> getTaxes() async {
    ...
    Uri _uri = getApiBaseUri("provider/taxes").replace(queryParameters: _queryParameters);
